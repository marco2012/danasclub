...
prenota_buttons.forEach((element) => {
    $(element).click(function () {
        if (isMobile() === true) {
            window
                .open(
                    "https://api.whatsapp.com/send?phone=393476873085&text=Ciao, vorrei prenotare una lezione dimostrativa",
                    "_blank"
                )
                .focus();
        } else {
            window.location.href =
                "mailto:donatella.lupia@gmail.com?subject=Lezione%20di%20prova%20gratuita&body=Ciao%2C%20vorrei%20prenotare%20una%20lezione%20di%20prova%20gratuita.";
        }
    });
});
